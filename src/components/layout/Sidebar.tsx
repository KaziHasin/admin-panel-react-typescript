                ...
                >
                    ...
                    >
                        {level === 0 ? (
                            ...
                            <span className="h-5 w-5 flex-shrink-0 flex items-center justify-center text-gray-500 dark:text-gray-400">
                                •
                            </span>
                        )}
                        {!collapsed && (
        ...
        <>
            ...
            >
                ...
                <nav className="flex-1 overflow-y-auto px-2 space-y-1">
                    {menuItems.map(item => {
                        if (item.path === '/ui-components') {
                            return (
                                <li key="ui-components">
                                    <button
                                        onClick={() => toggleSubmenu('ui')}
                                        className={`w-full flex items-center justify-between p-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg ${openSubmenus['ui'] ? 'bg-gray-100 dark:bg-gray-700' : ''
                                            }`}
                                    >
                                        ...
                                        <ChevronDownIcon
                                            className={`w-4 h-4 transition-transform ${openSubmenus['ui'] ? 'transform rotate-180' : ''
                                                }`}
                                        />
                                    </button>
                                    {openSubmenus['ui'] && (
                                        <ul className="ml-6 mt-2 space-y-2">
                                            <li>
                                                <button
                                                    ...
                                                    className={`w-full flex items-center justify-between p-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg ${openSubmenus['tables'] ? 'bg-gray-100 dark:bg-gray-700' : ''
                                                        }`}
                                                >
                                                    <div className="flex items-center">
                                                    ...
                                                    <ChevronDownIcon
                                                        className={`w-4 h-4 transition-transform ${openSubmenus['tables'] ? 'transform rotate-180' : ''
                                                            }`}
                                                    />
                                                </button>
                                                {openSubmenus['tables'] && (
                                                    <ul className="ml-8 mt-2 space-y-2">
                                                        <li>
                                                            <Link
                                                                to="/ui-components/tables/basic"
                                                                className="flex items-center p-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg"
                                                            >
                                                        ...
                                                        <li>
                                                            <Link
                                                                to="/ui-components/tables/advanced"
                                                                className="flex items-center p-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg"
                                                            >
                ...
                <div className="p-4 border-t border-gray-300 dark:border-gray-700">
                    <div className="relative">
                        {/* Notifications */}
                        <button className="p-2 rounded-full hover:bg-gray-300 dark:hover:bg-gray-800 transition-colors duration-200">
